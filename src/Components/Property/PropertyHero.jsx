...
import bgImage from "../../assets/property-image.jpg";
const PropertyHero = () => {
  return (
    <div className="relative w-full px-4">
      <div className="relative w-full overflow-hidden h-[540px] md:max-h-[600px] rounded-[14px] md:rounded-2xl">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-white/95 text-center text-sm sm:text-base md:text-lg max-w-2xl lg:max-w-3xl mb-8 sm:mb-12 px-4 leadFing-relaxed">
           Lorem ipsum dolor sit amet consectetur. Nec risus quis viverra libero tellus eget. Leo morbi faucibus mattis pharetra tellus velit ultricies duis rhoncus. Porttitor fermentum eu urna eget
          </p>
        </div>
      </div>
